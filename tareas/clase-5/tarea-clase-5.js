...
$calcularSalarioMensual.onclick = function(){
  const salarioAnual = document.querySelector('#salario-anual').value; //en los inputs se tiene que utilizar .value en vez de .innerText, etc.
  const salarioMensual = calcularSalarioMensual(salarioAnual);
  document.querySelector('#salario-mensual').value = salarioMensual;
  
  //console.log (salarioMensual);
  return false //esto es para que el formulario no se reenvie
}
